...
const BulkUploadJobTitlesModal = ({ isOpen, onClose, onSubmit }) => {
  ...
  const handleSubmit = () => {
    ...
    if (!paragraph) {
      toast.error("Please enter some job titles.");
      return;
    }
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center">
      <div className="bg-white p-6 rounded-lg shadow-lg w-[90%] max-w-xl relative">
        ...
        <h2 className="text-xl font-bold mb-4">Bulk Upload Job Titles</h2>
...
export default BulkUploadJobTitlesModal;
